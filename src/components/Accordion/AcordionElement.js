                  ...
                  <>
                    <h2>
                      ...
                      >
                        <Box flex="1" textAlign="left">
                          <Questions>
                            Is recording and storing conferences legal?
                          </Questions>
                        </Box>
                        {isExpanded ? (
                          <MinusIcon fontSize="12px" />
                    ...
                    <AccordionPanel pb={4}>
                      <Answer>
                        SEEYOU is EU-based. According to GDPR, you may only
                        record and store conferences for personal use. Please
                        consult your applicable laws and regulations if
                        recording and storing conferences outside of the EU/EEA
                      </Answer>
                    </AccordionPanel>
                  </>
                )}
              ...
              >
                {({ isExpanded }) => (
                  <>
                    ...
                    <AccordionPanel pb={4}>
                      <Answer>
                        No, limitations to the operating systems on iOS and
                        Android prevents recordings on mobile phones. So, for
                        now, this is a desktop feature only
                      </Answer>
                    </AccordionPanel>
                  </>
                )}
              ...
              >
                {({ isExpanded }) => (
                  <>
                    ...
                    <AccordionPanel pb={4}>
                      <Answer>
                        No, the same problem as with recordings. So, for now,
                        this is a desktop feature only
                      </Answer>
                    </AccordionPanel>
                  </>
                )}
              ...
              >
                {({ isExpanded }) => (
                  <>
                    ...
                    <AccordionPanel pb={4}>
                      <Answer>
                        Simple, if you open SEEYOU and click on any note taken
                        during a conference you have stored, the conference
                        opens where you started taking the note. Kind of cool
                        when preparing for an exam, a meeting, or whatever
                      </Answer>
                    </AccordionPanel>
                  </>
                )}
                  ...
                  <>
                    <h2>
                      ...
                      >
                        <Box flex="1" textAlign="left">
                          <Questions>
                            Are the chat and video messages end-to-end
                            encrypted?
                          </Questions>
                        </Box>
                        {isExpanded ? (
                    ...
                    <AccordionPanel pb={4}>
                      <Answer>
                        ...
                        end-to-end encrypted, meaning they’re genuinely private.
                        SEEYOU cannot read the content nor see with whom you are
                        communicating. Nor can anyone else
                      </Answer>

                      <Answer>
                        Unlike many other providers, this holds for group chats
                        too. The encryption key is personal and managed by your
                        mobile phone, and logs are not centrally stored by
                        SEEYOU but are yours alone
                      </Answer>
                    </AccordionPanel>
                  </>
                )}
                  ...
                  <>
                    <h2>
                      ...
                      >
                        <Box flex="1" textAlign="left">
                          <Questions>
                            Can I use SEEYOU's encrypted communication outside
                  ...
                  <>
                    <h2>
                      ...
                      >
                        <Box flex="1" textAlign="left">
                          <Questions>
                            Why must I download SEEYOU both on desktop and
                            mobile?
                          </Questions>
                        </Box>
                        {isExpanded ? (
              ...
              >
                {({ isExpanded }) => (
                  <>
                    ...
                    <AccordionPanel pb={4}>
                      <Answer>
                        On the desktop, you download it either from
                        www.seeyou.eu or from a link you either receive from a
                        friend or copy from social media. On mobile, you
                        download SEEYOU from the App Store or Google Play
                      </Answer>
                    </AccordionPanel>
                  </>
                )}
                  ...
                  <>
                    <h2>
                      ...
                      >
                        <Box flex="1" textAlign="left">
                          <Questions>
                            Why are the shares given as equity tokens?
                          </Questions>
                        </Box>
                        {isExpanded ? (
                          <MinusIcon fontSize="12px" />
                    ...
                    <AccordionPanel pb={4}>
                      <Answer>
                        Equity tokens are an easy way for users to earn
                        fractional shares, and they allow users to move their
                        holdings from SEEYOU to their own private cryptocurrency
                        wallets in the form of ECR-20 based SEUs
                      </Answer>
                    </AccordionPanel>
                  </>
                )}
                  ...
                  <>
                    <h2>
                      ...
                      >
                        <Box flex="1" textAlign="left">
                          <Questions>
                            Is SEEYOU looking for more people?
                          </Questions>
                        </Box>
                        {isExpanded ? (
                          <MinusIcon fontSize="12px" />
                    ...
                    <AccordionPanel pb={4}>
                      <Answer>
                        Yes, we are. If you find that your values align with
                        ours and you love what you do, we may be the place for
                        you
                      </Answer>
                    </AccordionPanel>
                  </>
